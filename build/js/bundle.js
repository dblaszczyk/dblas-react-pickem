...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pickem = __webpack_require__(159);

	var _pickem2 = _interopRequireDefault(_pickem);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	_reactDom2.default.render(_react2.default.createElement(_pickem2.default, null), document.getElementById('app')); // main.js
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _gamelist = __webpack_require__(160);
	...
	var Pickem = _react2.default.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    var listRequest = new Request('http://www.nfl.com/liveupdate/scores/scores.json', requestInit);

	    fetch(listRequest).then(function (data) {
	      return data.blob();
	    }).then(function (data) {
	      var gamesArray = [];
	      console.log(data);
	...
	var Team = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      'span',
	      null,
	      _react2.default.createElement('img', { src: 'http://i.nflcdn.com/static/site/7.2/img/logos/teams-matte-80x53/' + this.props.teamAbbr + '.png' }),
	      this.props.teamAbbr
	    );
	  }
	}); // ---------- Dependencies ---------- //
